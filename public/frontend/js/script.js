...
(function () {
	...
	$(function () {
		...
		function initOwlCarousel(c) {
			...
			for (var j = 0; j < values.length; j++) {
				...
				console.log(responsive[values[j]]["items"]);
			}
	...
	/*Chu Update 21-05-2021*/
	/*View content news detail*/
	$document.on('click','.url-item-news', function(e) {
		e.preventDefault();
		jQuery('body').addClass('active-news');
		jQuery('.modal-news-detail').fadeIn(400);
		var data_link = jQuery(this).attr('href');
		console.log(data_link);
	});
	$document.on('click','.close-news-detail', function() {
		jQuery('body').removeClass('active-news');
		jQuery('.modal-news-detail').fadeOut(400);
	});
}());
