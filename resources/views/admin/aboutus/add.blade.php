...
@section('content')
    <div class="main-content-container container-fluid px-4">
        @include('admin.partials.title-content', ['name'=>'Thêm aboutus'])

        <form action="{{ route('aboutus.store') }}" class="add-new-post" enctype="multipart/form-data" method="POST">
            @csrf
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <textarea required class="form-control tinymce_editor_init" id="qualified" name="qualified"
                        cols="10" rows="5"></textarea>
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input  type="number" min="1" max="100" required name="percent_risk" class="form-control" >
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="1" max="100" required name="audit_percentage" class="form-control" >
                    </div>
                </div>
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="1" max="100" required name="financial_percent" class="form-control" >
                    </div>
                </div>
            </div>
