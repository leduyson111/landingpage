...
@section('content')
    <div class="main-content-container container-fluid px-4">
        ...
        <form action="{{ route('services.store') }}" class="add-new-post" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" required name="title" class="form-control" placeholder="Nhập tiêu đề bài viết">
                    </div>
                </div>
