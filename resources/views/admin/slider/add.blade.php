...
@section('content')
    <div class="main-content-container container-fluid px-4">
        ...
        <form action="{{ route('slider.store') }}" class="add-new-post" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" required name="title" class="form-control" placeholder="Nhập tên phòng">
                    </div>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <div id="holder">
                        <img src='{{ !empty($post) ? $post->image : '' }}' style="width: 200px;">
                    </div>
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea required style="height: 500px;" class="form-control tinymce_editor_init" id="description"
                        name="description" cols="50" rows="30"></textarea>
                </div>
            </div>
