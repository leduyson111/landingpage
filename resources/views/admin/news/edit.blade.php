...
@section('content')
    <div class="main-content-container container-fluid px-4">
        ...
        <form action="{{ route('news.update' , ['id'=>$news->id]) }}" class="add-new-post" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" value="{{ $news->title }}" required name="title" class="form-control" >
                    </div>
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <div class="input-group">
                        ...
                        <input value="{{ $news->image }}" required id="image" class="form-control" type="text" name="image">
                    </div>
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea required style="height: 500px;" class="form-control tinymce_editor_init" id="description"
                        name="desc" cols="50" rows="30">{{ $news->desc }}</textarea>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea required style="height: 500px;" class="form-control tinymce_editor_init" id="our_clients"
                        name="our_clients" cols="50" rows="30"> {{ $news->our_clients }}</textarea>
                </div>
            </div>
